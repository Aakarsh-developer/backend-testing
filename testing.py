...
df = pd.read_csv(r"C:\Users\HP\Downloads\Prediction_price-main\Prediction_price-main\Future-crop-price-prediction-master\data\Copy of FRUITS(1).csv", usecols=fields)
